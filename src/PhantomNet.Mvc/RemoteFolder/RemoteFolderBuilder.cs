...
namespace PhantomNet.Mvc.RemoteFolder
{
    public class RemoteFolderBuilder
    {
        ...
        public virtual RemoteFolderBuilder AddRemoteFolderService<T>() where T : class
        {
            ...
            {
                throw new InvalidOperationException(string.Format(Resources.InvalidServiceType, customType.Name, nameof(RemoteFolderService<RemoteFile>), RemoteFileType.Name));
            }
        ...
        public virtual RemoteFolderBuilder AddRemoteImageFolderService<T>() where T : class
        {
            ...
            {
                throw new InvalidOperationException(string.Format(Resources.InvalidServiceType, customType.Name, nameof(RemoteImageFolderService<RemoteImage>), RemoteImageType.Name));
            }
